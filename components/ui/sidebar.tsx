...
export namespace SidebarGroup {
  export const Action = SidebarGroupAction;
  export const Content = SidebarGroupContent;
  export const Label = SidebarGroupLabel;
}

export namespace SidebarMenu {
  export const Button = SidebarMenuButton;
  export const Item = SidebarMenuItem;
  export const Skeleton = SidebarMenuSkeleton;
  export const Sub = SidebarMenuSub;
  export const SubButton = SidebarMenuSubButton;
  export const SubItem = SidebarMenuSubItem;
}
